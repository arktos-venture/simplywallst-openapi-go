...
type CompanyAnalysisExtendedAnalysisDividend struct {
	...
	HistoricalDividendYield        interface{} `json:"historical_dividend_yield,omitempty"`
	HistoricalDividendPayments     interface{} `json:"historical_dividend_payments,omitempty"`
	MergedFutureDividendsPerShare  interface{} `json:"merged_future_dividends_per_share,omitempty"`
	MergedFutureYield              interface{} `json:"merged_future_yield,omitempty"`
}
