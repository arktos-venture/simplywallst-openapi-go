...
// CompanyAnalysisExtendedRawDataMembersLeaderData struct for CompanyAnalysisExtendedRawDataMembersLeaderData
type CompanyAnalysisExtendedRawDataMembersLeaderData struct {
...
func NewCompanyAnalysisExtendedRawDataMembersLeaderData() *CompanyAnalysisExtendedRawDataMembersLeaderData {
	this := CompanyAnalysisExtendedRawDataMembersLeaderData{}
	return &this
}
...
func (o CompanyAnalysisExtendedRawDataMembersLeaderData) MarshalJSON() ([]byte, error) {
...
type NullableCompanyAnalysisExtendedRawDataMembersLeaderData struct {
	value *CompanyAnalysisExtendedRawDataMembersLeaderData
	isSet bool
}

func (v NullableCompanyAnalysisExtendedRawDataMembersLeaderData) Get() *CompanyAnalysisExtendedRawDataMembersLeaderData {
	return v.value
}

func (v *NullableCompanyAnalysisExtendedRawDataMembersLeaderData) Set(val *CompanyAnalysisExtendedRawDataMembersLeaderData) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyAnalysisExtendedRawDataMembersLeaderData) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyAnalysisExtendedRawDataMembersLeaderData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyAnalysisExtendedRawDataMembersLeaderData(val *CompanyAnalysisExtendedRawDataMembersLeaderData) *NullableCompanyAnalysisExtendedRawDataMembersLeaderData {
	return &NullableCompanyAnalysisExtendedRawDataMembersLeaderData{value: val, isSet: true}
}

func (v NullableCompanyAnalysisExtendedRawDataMembersLeaderData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyAnalysisExtendedRawDataMembersLeaderData) UnmarshalJSON(src []byte) error {
	v.isSet = true
