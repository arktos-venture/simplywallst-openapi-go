...
### NewCompanyAnalysisExtendedAnalysisMisc
...
### NewCompanyAnalysisExtendedAnalysisMiscWithDefaults
...
GetIsFund returns the IsFund field if non-nil, zero value otherwise.

### GetIsFundOk

`func (o *CompanyAnalysisExtendedAnalysisMisc) GetIsFundOk() (*bool, bool)`

GetIsFundOk returns a tuple with the IsFund field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIsFund sets IsFund field to given value.
...
### GetDaysSinceLastTrade

`func (o *CompanyAnalysisExtendedAnalysisMisc) GetDaysSinceLastTrade() int32`

GetDaysSinceLastTrade returns the DaysSinceLastTrade field if non-nil, zero value otherwise.

### GetDaysSinceLastTradeOk

`func (o *CompanyAnalysisExtendedAnalysisMisc) GetDaysSinceLastTradeOk() (*int32, bool)`

GetDaysSinceLastTradeOk returns a tuple with the DaysSinceLastTrade field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDaysSinceLastTrade

`func (o *CompanyAnalysisExtendedAnalysisMisc) SetDaysSinceLastTrade(v int32)`

SetDaysSinceLastTrade sets DaysSinceLastTrade field to given value.

### HasDaysSinceLastTrade
...
### HasSharesOutstandingSingleGrowth1y
...
### HasSharesOutstandingSingleGrowth5y
