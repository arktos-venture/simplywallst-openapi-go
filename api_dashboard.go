...
*/
func (a *DashboardApiService) ListIndustryPerformance(ctx _context.Context, country string) (IndustryPerformance, *_nethttp.Response, error) {
	var (
...
*/
func (a *DashboardApiService) ListInternationalMarket(ctx _context.Context) (InternationalMarket, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dashboard/international-markets"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *DashboardApiService) ListMarketPerformance(ctx _context.Context, country string) (MarketPerformance, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
